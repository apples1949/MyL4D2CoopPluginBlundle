...
public void OnAllPluginsLoaded()
{
	...
	{
		LogMessage("\n==========\n警告: 你应该安装 \"[L4D & L4D2] Use Priority Patch\" 以修复附加在玩家身上的模型阻挡使用键问题 (item hint): https://forums.alliedmods.net/showthread.php?t=327511\n==========\n");
	}
}
...
public void OnPluginStart()
{
	...
	g_hItemCvarColor		= CreateConVar("l4d2_item_hint_glow_color", "0 255 255", "物品发光颜色，自行去 https://tool.oschina.net/commons?type=3 比对颜色(无内容=禁用物品发光)", FCVAR_NOTIFY);
	...
	g_hSpotMarkCvarColor		= CreateConVar("l4d2_spot_marker_color", "200 200 200", "标记颜色，自行去 https://tool.oschina.net/commons?type=3 比对颜色(无内容=禁用标记)", FCVAR_NOTIFY);
	...
	g_hSpotMarkInstructorColor	= CreateConVar("l4d2_spot_marker_instructorhint_color", "200 200 200", "标记上方提示的颜色，自行去 https://tool.oschina.net/commons?type=3 比对颜色", FCVAR_NOTIFY);
	...
	g_hInfectedMarkCvarColor   	= CreateConVar("l4d2_infected_marker_glow_color", "255 120 203", "特殊感染者标记颜色，自行去 https://tool.oschina.net/commons?type=3 比对颜色(无内容=禁用特殊感染者发光)", FCVAR_NOTIFY);
