...
*/
//物品id 物品翻译名称 请参考上面注释内容 两者搭配不可更改
static char weapons_name_standard[][][] = 
{
	{"pain_pills", "Pain Pill"},
	{"adrenaline", "Adrenaline"},
...
static char weapon_ammo[][][] =
{
	...
	{"weapon_rifle_ak47",  				"3",	"240"},
	{"weapon_rifle_desert",				"3", 	"180"},
	{"weapon_sniper_military",			"10", 	"90"},
	{"weapon_grenade_launcher", 	 	"17", 	"10"},
	{"weapon_rifle_sg552",	 			"3", 	"200"},
	{"weapon_rifle_m60",  				"6",	"450"},
...
public void OnPluginStart()
{
	...
	cvar_gift_enable = CreateConVar("l4d2_gifts_enabled",									"1", 		"启用插件? 0: 禁用, 1: 启用", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	cvar_gift_life = CreateConVar("l4d2_gifts_gift_life",									"30",		"礼物在地上最多保存多长时间 (秒)", FCVAR_NOTIFY, true, 0.0);
	cvar_gift_chance = CreateConVar("l4d2_gifts_chance", 									"50",		"特感掉落正常礼物的概率 (%).", FCVAR_NOTIFY, true, 1.0, true, 100.0);
	cvar_special_gift_chance = CreateConVar("l4d2_specail_gifts_chance", 					"100",		"坦克或女巫掉落特殊礼物的概率 (%).", FCVAR_NOTIFY, true, 1.0, true, 100.0);
	cvar_gift_Announce = CreateConVar("l4d2_gifts_announce_type",							"3",		"如何通知玩家谁获得礼物以及得到了什么. (0: 关闭, 1:聊天框, 2: 提示框, 3:屏幕中间)", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	cvar_gift_infected_hp = CreateConVar("l4d2_gifts_infected_reward_hp",					"200",		"特感接触到标准礼物回复多少血量. (0=禁用)", FCVAR_NOTIFY, true, 0.0);
	cvar_special_gift_infected_hp = CreateConVar("l4d2_gifts_special_infected_reward_hp",	"400",		"特感接触到特殊礼物回复多少血量. (0=禁用)", FCVAR_NOTIFY, true, 0.0);
	cvar_blockSwitch = 				CreateConVar("l4d2_gifts_block_switch",					"1",		"如果为1, 防止生还者在打开礼物自动拾取获取的新武器", FCVAR_NOTIFY, true, 0.0);
	...
	RegAdminCmd("sm_gifts", Command_Gift, ADMFLAG_CHEATS, "在你的位置生成一个礼物");
