...
public void OnPluginStart()
{
	...
	CheckRoundCounterCoop = CreateConVar("sm_l4d_fmc_crec_coop_map", "1", "战役/写实模式中，非最后一关团灭多少次换图 (0=关)", FCVAR_NOTIFY, true, 0.0);
	CheckRoundCounterCoopFinal = CreateConVar("sm_l4d_fmc_crec_coop_final", "1", "战役/写实模式中,最后一关团灭多少次换图 (0=关)", FCVAR_NOTIFY, true, 0.0);
	CheckRoundCounterSurvival = CreateConVar("sm_l4d_fmc_crec_survival_map", "5", "生还者模式中团灭多少次换图(0=关)", FCVAR_NOTIFY, true, 0.0);
	ChDelayVS = CreateConVar("sm_l4d_fmc_delay_vs", "0.0", "对抗模式中一场游戏结束后多少秒换图 (0=关)", FCVAR_NOTIFY, true, 0.0);
	ChDelaySurvival = CreateConVar("sm_l4d_fmc_delay_survival", "0.0", "生还者模式中一场游戏结束后多少秒换图 (0=关)", FCVAR_NOTIFY, true, 0.0);
