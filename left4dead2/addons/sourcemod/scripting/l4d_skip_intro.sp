...
{
	g_hCvarAllow = CreateConVar(	"l4d_skip_intro_allow",			"1",			"0=插件禁用  1=插件启用", CVAR_FLAGS );
	g_hCvarModes = CreateConVar(	"l4d_skip_intro_modes",			"",				"在这些游戏模式中启用插件, 用英文逗号隔开(无空格). (无内容=全部游戏模式)", CVAR_FLAGS );
	g_hCvarModesOff = CreateConVar(	"l4d_skip_intro_modes_off",		"",				"在这些游戏模式中关闭插件, 用英文逗号隔开(无空格). (无内容=无)", CVAR_FLAGS );
	g_hCvarModesTog = CreateConVar(	"l4d_skip_intro_modes_tog",		"0",			"在这些游戏模式中启用插件. 0=全部游戏模式, 1=战役, 2=生还者, 4=对抗, 8=清道夫. 将这些数字叠加在一起", CVAR_FLAGS );
