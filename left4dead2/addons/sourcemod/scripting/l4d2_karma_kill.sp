...
public void OnPluginStart()
{
	...
	karmaAwardConfirmed              = CreateConVar("l4d2_karma_award_confirmed", 				"1", 	"用player_death事件确认奖励一个确认的慢动作制造者.", CVAR_FLAGS, true, 0.0, true, 1.0);
	...
	//cvarNoFallDamageProtectFromIncap = CreateConVar("l4d2_karma_kill_no_fall_damage_protect_from_incap", "1", "如果倒地时受到超过224的伤害则死亡", CVAR_FLAGS, true, 0.0, true, 1.0);
