...
public void OnPluginStart()
{
	...
	hCountChainsawHead	   = CreateConVar("l4d2_Kill_inf_health_ammo_chainsaw_head", "10", "电锯击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountChainsawShot	   = CreateConVar("l4d2_Kill_inf_health_ammo_chainsaw_shot", "20", "电锯爆头击杀一个特感奖励多少前置弹药(不包括坦克,好像电锯没有爆头判定). 0=禁用.", FCVAR_NOTIFY);
