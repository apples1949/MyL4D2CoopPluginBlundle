...
ConVar g_hCvarAllow, g_hCvarCrawl, g_hCvarCrazy, g_hCvarGlow, g_hCvarHurt, g_hCvarMPGameMode, g_hCvarModes, g_hCvarModesOff, g_hCvarModesTog, g_hCvarRate, g_hCvarSpeed, g_hCvarSpeeds, g_hCvarSpit, g_hCvarView;
//int g_iClone[MAXPLAYERS+1], g_iDisplayed[MAXPLAYERS+1], g_iHint, g_iHints, g_iHurt, g_iRate, g_iSpeed, g_iView;
int g_iClone[MAXPLAYERS+1], g_iDisplayed[MAXPLAYERS+1], g_iHurt, g_iRate, g_iSpeed, g_iView;
