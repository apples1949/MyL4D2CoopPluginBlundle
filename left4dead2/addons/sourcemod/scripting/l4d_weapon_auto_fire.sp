...
public void OnPluginStart()
{
    ...
    g_hCvar_Enabled                    = CreateConVar("l4d_weapon_auto_fire_enable", "1", "启用/禁用插件.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_WeaponSwitch               = CreateConVar("l4d_weapon_auto_fire_weapon_switch", "1", "是否启用武器全自动射击.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_MachineGunRelease          = CreateConVar("l4d_weapon_auto_fire_machine_gun_release", "1", "放开重机枪后是否启用全自动射击.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_ShotgunReloadEmpty         = CreateConVar("l4d_weapon_auto_fire_shotgun_reload_empty", "1", "当霰弹弹夹子弹用完时自动换弹.\n0 = 禁用, 1 = 启用, 2 = 启用但强制换完子弹.", CVAR_FLAGS, true, 0.0, true, 2.0);
    g_hCvar_Pistol                     = CreateConVar("l4d_weapon_auto_fire_pistol", "1", "单持手枪全自动射击.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_Pistol_Frame               = CreateConVar("l4d_weapon_auto_fire_pistol_frame", "3", "必须等待多少帧才能启用单持手枪全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
    g_hCvar_Pistol_ForceSound          = CreateConVar("l4d_weapon_auto_fire_pistol_force_sound", "1", "当单持手枪射击时强制向射击者播放枪械声音.\n其他玩家不会受到影响. 第一发射击声音将被忽略.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_DualPistol                 = CreateConVar("l4d_weapon_auto_fire_dual_pistol", "1", "双持手枪全自动射击.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_DualPistol_Frame           = CreateConVar("l4d_weapon_auto_fire_dual_pistol_frame", "3", "必须等待多少帧才能启用双持手枪全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
    g_hCvar_DualPistol_ForceSound      = CreateConVar("l4d_weapon_auto_fire_dual_pistol_force_sound", "1", "当双持手枪射击时强制向射击者播放枪械声音.\n其他玩家不会受到影响. 第一发射击声音将被忽略.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_PumpShotgun                = CreateConVar("l4d_weapon_auto_fire_pump_shotgun", "1", "木喷全自动射击.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_PumpShotgun_Frame          = CreateConVar("l4d_weapon_auto_fire_pump_shotgun_frame", "0", "必须等待多少帧才能启用木喷全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
    g_hCvar_AutoShotgun                = CreateConVar("l4d_weapon_auto_fire_auto_shotgun", "1", "Xm104霰弹全自动射击.\n此武器在原版游戏中已有全自动射击功能.\n启用后攻击速度加快.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_AutoShotgun_Frame          = CreateConVar("l4d_weapon_auto_fire_auto_shotgun_frame", "0", "必须等待多少帧才能启用Xm104霰弹全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
    g_hCvar_Hunting_Rifle              = CreateConVar("l4d_weapon_auto_fire_hunting_rifle", "1", "木制猎枪全自动射击.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_Hunting_Rifle_Frame        = CreateConVar("l4d_weapon_auto_fire_hunting_rifle_frame", "0", "必须等待多少帧才能启用木制猎枪全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);

    if (g_bL4D2)
    {
        g_hCvar_Pistol_Magnum          = CreateConVar("l4d_weapon_auto_fire_pistol_magnum", "1", "马格南全自动射击.\n仅求生之路2.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
        g_hCvar_Pistol_Magnum_Frame    = CreateConVar("l4d_weapon_auto_fire_pistol_magnum_frame", "0", "必须等待多少帧才能启用马格南全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
        g_hCvar_Shotgun_Chrome         = CreateConVar("l4d_weapon_auto_fire_shotgun_chrome", "1", "铁喷全自动射击.\n仅求生之路2.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
        g_hCvar_Shotgun_Chrome_Frame   = CreateConVar("l4d_weapon_auto_fire_shotgun_chrome_frame", "0", "必须等待多少帧才能启用铁喷全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
        g_hCvar_Shotgun_Spas           = CreateConVar("l4d_weapon_auto_fire_shotgun_spas", "1", "SPAS霰弹全自动射击.\n仅求生之路2.\n此武器在原版游戏中已有全自动射击功能.\n启用后攻击速度加快.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
        g_hCvar_Shotgun_Spas_Frame     = CreateConVar("l4d_weapon_auto_fire_shotgun_spas_frame", "0", "必须等待多少帧才能启用SPAS霰弹全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
        g_hCvar_Sniper_Military        = CreateConVar("l4d_weapon_auto_fire_sniper_military", "1", "军用狙击全自动射击.\n仅求生之路2.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
        g_hCvar_Sniper_Military_Frame  = CreateConVar("l4d_weapon_auto_fire_sniper_military_frame", "0", "必须等待多少帧才能启用军用狙击全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
        g_hCvar_Sniper_Scout           = CreateConVar("l4d_weapon_auto_fire_sniper_scout", "1", "鸟狙全自动射击.\n仅求生之路2.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
        g_hCvar_Sniper_Scout_Frame     = CreateConVar("l4d_weapon_auto_fire_sniper_scout_frame", "0", "必须等待多少帧才能启用鸟狙全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
        g_hCvar_Sniper_AWP             = CreateConVar("l4d_weapon_auto_fire_sniper_awp", "1", "AWP全自动射击.\n仅求生之路2.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
        g_hCvar_Sniper_AWP_Frame       = CreateConVar("l4d_weapon_auto_fire_sniper_awp_frame", "0", "必须等待多少帧才能启用AWP全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
        g_hCvar_Grenade_Launcher       = CreateConVar("l4d_weapon_auto_fire_grenade_launcher", "1", "榴弹发射器全自动射击.\n仅求生之路2.\n0 = 禁用, 1 = 启用.", CVAR_FLAGS, true, 0.0, true, 1.0);
        g_hCvar_Grenade_Launcher_Frame = CreateConVar("l4d_weapon_auto_fire_grenade_launcher_frame", "0", "必须等待多少帧才能启用榴弹发射器全自动射击.\n立刻使用\"weapon_fire\"事件.", CVAR_FLAGS, true, 0.0);
    }
